<template>
    ...
    <section class="about-section padding">
        ...
        <card-component titulo="Curiosities">
            ...
            banner: { titulo: 'Banner', tipo: 'imagem' },
            title: { titulo: 'Titulo', tipo: 'texto' },
            caption: { titulo: 'Caption', tipo: 'texto' },
            description: { titulo: 'Description', tipo: 'texto' },
            video: { titulo: 'Video', tipo: 'texto' },
        }"></table-component>
            </template>
        ...
        <modal-component id="modalVisualizar" :titulo="this.$store.state.item.title">
            <template v-slot:conteudo>
                <h3>{{ this.$store.state.item.caption }}</h3>
                <img :src="'storage/' + $store.state.item.banner" v-if="$store.state.item.banner">
                <hr>
                <p>{{ this.$store.state.item.description }}</p>
                <hr>
        ...
        <modal-component id="modalRemover" :titulo="this.$store.state.item.title">
        ...
        <modal-component id="modalAtualizar" titulo="Atualizar">
            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component titulo="Title" id="atualizarTitle" id-help="atualizarTitleHelp"
                        texto-ajuda="Background title">
                        <input type="text" class="form-control" id="atualizarTitle"
                            aria-describedby="atualizarTitleHelp" placeholder="Nome da marca"
                            v-model="$store.state.item.title">
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="Caption" id="atualizarCaption" id-help="CaptionHelp"
                        texto-ajuda="Description max 30 caracters">
                        <input type="text" class="form-control" id="atualizarCaption" aria-describedby="CaptionHelp"
                            placeholder="Caption" v-model="$store.state.item.caption">
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="Description" id="atualizarDescription" id-help="DescriptionHelp"
                        texto-ajuda="Description max 50 caracters">
                        <input type="text" class="form-control" id="atualizarDescription"
                ...
                <div class="form-group">
                    <input-container-component titulo="Video" id="atualizarVideo" id-help="VideoHelp"
                        texto-ajuda="Description max 30 caracters">
                        <input type="text" class="form-control" id="atualizarVideo" aria-describedby="VideoHelp"
                            placeholder="Video" v-model="$store.state.item.video">
                    </input-container-component>
                </div>

                <div class="form-group">
                    <input-container-component titulo="Active" id="atualizarActive" id-help="ActiveHelp"
                        texto-ajuda="0 = inative / 1 = active">
                        <input type="text" class="form-control" id="atualizarActive" aria-describedby="ActiveHelp"
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <img class="rounded mr-2" alt="banner" width="350" v-if="bannerImage" :src="bannerImage" />

                        <!-- Segunda imagem (se bannerImage não estiver definido, mas houver um arquivo selecionado) -->
                        <img class="rounded mr-2" alt="banner" width="350"
                            v-else-if="urlimg + this.$store.state.item.banner"
                            :src="urlimg + this.$store.state.item.banner" />

                        <!-- Terceira imagem (se nenhum bannerImage nem arquivo selecionado estiver definido) -->
                        <img class="rounded mr-2" alt="banner" width="350" v-else
                    ...
                    <div class="custom-file">
                        ...
                        <input-container-component titulo="banner" id="ibannercon" id-help="AttIconHelp"
                            texto-ajuda="0 = inative / 1 = active">
                            <input id="banner" type="file" class="custom-file-input" @change="handleBannerUpload" />
                        </input-container-component>
        ...
        <modal-component id="modalSalvar" titulo="Novo">
            ...
            <template v-slot:conteudo>
                ...
                <div class="form-group">
                    <input-container-component titulo="Caption" id="caption" id-help="CaptionHelp"
                        texto-ajuda="Description max 30 caracters">
                        <input type="text" class="form-control" id="caption" aria-describedby="CaptionHelp"
                            placeholder="Caption" v-model="caption">
                    </input-container-component>
                </div>
                ...
                <div class="form-group">
                    <input-container-component titulo="Video" id="video" id-help="VideoHelp"
                        texto-ajuda="Description max 30 caracters">
                        <input type="text" class="form-control" id="video" aria-describedby="VideoHelp"
                            placeholder="Video" v-model="video">
                    </input-container-component>
                </div>
                ...
                <div class="card-body">
                    <h4 class="card-title">Background (Banner)</h4>
                    <p class="card-title-desc">For a better experience, choose a standard image (1500 x 1000)</p>
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- Terceira imagem (se nenhum bannerImage nem arquivo selecionado estiver definido) -->
                        <img class="rounded mr-2" alt="Banner" width="350" v-else
                            :src="urlimg + 'banners/defaultbanner.jpg'" />
                    </div>
                    <br>
                    ...
                    <div class="custom-file">
                        ...
                        <input-container-component titulo="Banner" id="banner" id-help="AttBannerHelp">
                            <input id="banner" type="file" class="custom-file-input" @change="handleBannerUpload" />
                        </input-container-component>
...
export default {
    data() {
        return {
            urlBase: import.meta.env.VITE_APP_API_URL + '/api/v1/curiosity',
    ...
    methods: {
        ...
        salvar() {
            ...
            if (this.banner) { // Verifica se uma imagem foi selecionada
                formData.append('banner', this.banner); // Adiciona a imagem ao FormData
            }
            ...
            axios.post(url, formData)
                .then(response => {
                    ...
                    banner.value = '' //resetando o campo de imagem
